...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250902154729_update_GamerConfiguration")]
    partial class update_GamerConfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.GamerGame", b =>
                {
                    b.Property<long>("GamerId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Entities.XblAuth.XboxAuthToken", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.XblAuth.XboxXauToken", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.XblAuth.XboxXstsToken", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.Achievement", b =>
                {
                    b.HasOne("Domain.Entities.Game", "GameLink")
            ...
            modelBuilder.Entity("Domain.Entities.Gamer", b =>
                {
                    b.HasOne("Domain.Entities.ApplicationUser", "ApplicationUserLink")
                        .WithOne("Gamer")
                        .HasForeignKey("Domain.Entities.Gamer", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ApplicationUserLink");
                });
            ...
            modelBuilder.Entity("Domain.Entities.GamerAchievement", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Gamer", "GamerLink")
                        .WithMany("GamerAchievementLinks")
                        .HasForeignKey("GamerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Achievement", "AchievementLink")
                        .WithMany("GamerAchievementLinks")
            ...
            modelBuilder.Entity("Domain.Entities.XblAuth.XboxXauToken", b =>
                {
                    b.HasOne("Domain.Entities.XblAuth.XboxAuthToken", "XboxOAuthTokenLink")
                        .WithOne("XboxXauTokenLink")
                        .HasForeignKey("Domain.Entities.XblAuth.XboxXauToken", "UserIdFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.XblAuth.XboxXstsToken", b =>
                {
                    b.HasOne("Domain.Entities.XblAuth.XboxXauToken", "XboxXauTokenLink")
                        .WithOne("XboxXstsTokenLink")
                        .HasForeignKey("Domain.Entities.XblAuth.XboxXstsToken", "UhsIdFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
